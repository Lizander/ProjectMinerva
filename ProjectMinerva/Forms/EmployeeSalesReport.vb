...
Public Class EmployeeSalesReport
    ...
    Private Sub EmployeeSalesReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub EmployeeSalesReport_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
